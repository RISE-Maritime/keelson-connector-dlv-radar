    ...
    with zenoh.open(conf) as zsession:
        ...
        def onMessage(msg, v1, v2):
            ...
            point_cloud.fields.add(
                name="x", offset=0, type=PackedElementField.NumericType.FLOAT32)
            point_cloud.fields.add(
                name="y", offset=4, type=PackedElementField.NumericType.FLOAT32)
            point_cloud.fields.add(
                name="i", offset=8, type=PackedElementField.NumericType.FLOAT32)
        ...
        odsession.registerMessageCallback(
            PointCloudMsgID, onMessage, opendlv_message_standard_pb2.opendlv_proxy_PointCloudAngularLayeredReading)
        odsession.connect()
